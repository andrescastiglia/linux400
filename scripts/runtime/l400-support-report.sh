...
loader_runtime_version="$(read_status_field "${loader_status}" runtime_version || true)"
loader_ebpf_version="$(read_status_field "${loader_status}" ebpf_version || true)"
loader_effective_mode="$(read_status_field "${loader_status}" effective_mode || true)"
loader_known_gaps="$(read_status_field "${loader_status}" known_gaps || true)"
...
loader_runtime_version=${loader_runtime_version:-unknown}
loader_ebpf_version=${loader_ebpf_version:-unknown}
loader_effective_mode=${loader_effective_mode:-unknown}
loader_known_gaps=${loader_known_gaps:-unknown}
