...
pub const L400_SPOOL_OWNER_ATTR: &str = "user.l400.spool.owner";
pub const L400_SPOOL_JOB_ATTR: &str = "user.l400.spool.job";
pub const L400_SPOOL_OUTQ_ATTR: &str = "user.l400.spool.outq";
pub const L400_SPOOL_STATUS_ATTR: &str = "user.l400.spool.status";
pub const L400_SPOOL_SIZE_ATTR: &str = "user.l400.spool.size";
pub const L400_SPOOL_PAGES_ATTR: &str = "user.l400.spool.pages";
pub const L400_SPOOL_CREATED_ATTR: &str = "user.l400.spool.created";
